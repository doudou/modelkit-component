...
describe ModelKit::Component::Operation do
    ...
    describe "#to_h" do
        attr_reader :task, :op
        before do
            @task = ModelKit::Component::TaskContext.new(project)
    ...
    describe "#find_interface_type" do
        ...
        before do
            ...
            @project = project
            @op = ModelKit::Component::Operation.new(task, 'op')
        end
        ...
        it "should accept plain Types type objects" do
