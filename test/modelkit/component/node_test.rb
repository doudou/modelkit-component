...
describe ModelKit::Component::Node do
    ...
    describe "#task_model_from_name" do
        ...
        before do
            ...
            dependency = ModelKit::Component::Project.new(loader)
        ...
        it "should raise ArgumentError if the task does not exist" do
            assert_raises(ModelKit::TaskModelNotFound) { project.task_model_from_name("Bla") }
        end
        it "should raise ArgumentError if a task from a dependency is required as a relative name" do
            assert_raises(ModelKit::TaskModelNotFound) { project.task_model_from_name("Foo") }
        end
    ...
    describe "#operation" do
        it "registers the operation in self_operations" do
            ...
            assert_kind_of ModelKit::Component::Operation, meth
    ...
    ModelKit::Component::Node::STATE_TYPES.each do |type|
    ...
    describe "dynamic port support" do
        ...
        describe "in subclasses" do
            ...
            before do
                @parent_task = task
                @task = ModelKit::Component::Node.new(parent_task.project)
    ...
    describe "#to_h" do
        attr_reader :task
        before do
            @task = ModelKit::Component::Node.new(create_dummy_project, "test::Task")
        end
