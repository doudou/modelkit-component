...
describe ModelKit::Loaders::PkgConfig do
    ...
    it "should be able to enumerate the projects" do
        ...
        loader = ModelKit::Loaders::PkgConfig.new('oroarch')
    ...
    describe "#project_model_text_from_name" do
        ...
        it "should raise ModelKit::ProjectNotFound for unknown projects" do
            stub_orogen_pkgconfig_final
            loader = ModelKit::Loaders::PkgConfig.new('oroarch')
            assert_raises(ModelKit::ProjectNotFound) { loader.project_model_text_from_name('base') }
        end
    end
    ...
    describe "#typekit_model_text_from_name" do
        ...
        it "should raise ModelKit::TypekitNotFound for unknown projects" do
            stub_orogen_pkgconfig_final
            loader = ModelKit::Loaders::PkgConfig.new('oroarch')
            assert_raises(ModelKit::TypekitNotFound) { loader.typekit_model_text_from_name('base') }
        end
    end
end
