    ...
    module Component
        module Loaders
            class Files < Base
                ...
                def to_s;
                    "#<ModelKit::Loaders::Files(#{object_id.to_s(16)}) projects=#{available_projects.keys.sort.join(",")} typekits=#{available_typekits.keys.sort.join(",")}>"
                end
                ...
                def each_project
                    ...
                    available_projects.each_key do |project_name|
                        project = begin
                                      ...
                                      ModelKit.warn "could not load #{project_name}: #{e.message}"
                                      next
                                  end
